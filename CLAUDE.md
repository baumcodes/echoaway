...
- **@docs/runtime-flow.md** — visual (mermaid) of the realtime audio + control loop and the demo conversation sequence. Read first when reasoning about who calls what during a voice session.
